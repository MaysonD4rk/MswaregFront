...
textTo.addEventListener('keydown', (event) => {
    ...
    axios.get('http://localhost:3000/searchUser/' + document.getElementById('textTo').value)
        .then((res) => {
...
function searchMsg() {
    ...
    axios.get('http://localhost:3000/searchMsgList/0/' + document.getElementById('search').value)
        .then(msgs => {
